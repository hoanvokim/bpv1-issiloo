        ...
        <div class="container">
            ...
            <div class="row has-bg">
                <div class="col-md-6 col-12">
                    <!-- Form Start -->
                    <form action="#" method="post" class="tex">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-12">
                                <input class="form-control form-component"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <select class="form-control form-component">
                                    <option value="volvo">Chương trình mong muốn</option>
                ...
                <div class="col-md-6 col-12 text-left">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <span style="font-weight: 700;">Mail: </span> <a href="mailto: kr-info@issiloo.edu.vn"><span>kr-info@issiloo.edu.vn</span></a>
                        </div>
                        <div class="col-6">
            ...
            <div class="row">
                <div class="col-12 maps">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.8660891691675!2d106.76952956544376!3d10.821558392290891!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317526f88d44537d%3A0x582a5580cd585a9f!2zVHLGsOG7nW5nIENhbyDEkeG6s25nIEvhu7kgbmdo4buHIElJ!5e0!3m2!1sen!2s!4v1539845265163" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </section>
